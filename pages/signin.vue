        ...
        <div class="welc">
          ...
          <v-form ref="form" v-model="valid" lazy-validation @submit.prevent="handleSubmit">
            <div class="fields">
              ...
              <v-text-field rounded color="#f8a83644" v-model="credentials.email" :rules="emailRules"></v-text-field><br><br>
              <small>Password</small><br>
              <v-text-field type="password" rounded slot flat style="position:relative; z-index:0;" color="#f8a83644" v-model="credentials.password" :rules="passwordRules"></v-text-field><br><br><br>
    ...
    methods: {
      ...
      async handleSubmit () {
        ...
        try {
            ...
            await this.$apolloHelpers.onLogin(logUser.loginUser.token, undefined, 7)
            console.dir(res)
            await this.setUser()
